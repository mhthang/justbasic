(function (angular, factory) {
    ...
    app.run(['$q', '$timeout', function ($q, $timeout) {
        ...
        CKEDITOR.config.contentsCss = ['https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css', 'https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css', 'mycustom.css'];
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                var onLoad = function () {
                    var options = {
                        ...
                        //     { name: 'colors' },
                        //     {name :'format', items:['TextColor', 'BGColor', 'RemoveFormat']},
