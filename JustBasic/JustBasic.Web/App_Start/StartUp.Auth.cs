...
[assembly: OwinStartup(typeof(JustBasic.Web.App_Start.Startup))]
namespace JustBasic.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(JustBasicDbContext.Create);
            ...
            app.UseFacebookAuthentication(
               appId: "225716058005586",
               appSecret: "7662447aa336a873fc582e4b597ef928");
        ...
        public class AuthorizationServerProvider : OAuthAuthorizationServerProvider
        {
            ...
            public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
            {
                ...
                if (user != null)
                {
                    ...
                    var aa = listGroup.Where(x => x.Name == "Admin").FirstOrDefault();
                    var list = listGroup.ToList();
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<JustBasicDbContext>());
